...
if __name__ == '__main__':
    kg_path = '../data/TempQuestions/kg/tkbc_processed_data/ent_id'
    input_path = '../data/TempQuestions/questions/'
    output_path = '../data/TempQuestions/questions/processed_questions/'
    ...
    for d in ['test','dev','train']:
        ...
        with open(input_path+d+'.json','r',encoding='utf-8',errors='ignore') as f:
            dataset = json.load(f)
        #with open(input_path+d+'.pickle','r',encoding='utf-8',errors='ignore') as f:
            #ss = f.read()
            #bb = bytes(ss,'utf-8')
        ...
        with open(output_path + d + '.json', 'w',encoding='utf-8',errors='ignore') as obj:
