...
if __name__ == '__main__':
    kg_path = '../data/timequestions/kg/tkbc_processed_data/ent_id'
    input_path = '../data/timequestions/questions/'
    output_path = '../data/timequestions/questions/processed_questions/'
